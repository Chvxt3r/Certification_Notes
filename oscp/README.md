...
|Report Writing for Penetration Testers |Craft clear, actionable reports to detail security vulnerabilities, their potential impact, and by-step remediation guidance |
...
|The Metasploit Framework |Use Metasploitʼs broad capabilities for exploit development, payload generations, and post-exploitation activities to streamline your penetration testing tasks|
...
|Lateral Movement in Active Directory |Move laterally in Active Directory environments, expand your control, and achieve your penetration testing objectives with post-exploitation techniques and tools |


## Pricing/Plans
[Offsec Learn One Plan](https://www.offsec.com/pricing/)


## Resource/Practice Links
[OSCP+ Practice Machine List by 0xdf](https://0xdf.gitlab.io/cheatsheets/offsec)
